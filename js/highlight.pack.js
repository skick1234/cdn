                    ...
                    for (var i = t.firstChild; i; i = i.nextSibling)
                        3 === i.nodeType
                            ...
                            : 1 === i.nodeType &&
                              ...
                              (a = e(i, a)),
                              r(i).match(/br|hr|img|input/) || n.push({ event: "stop", offset: a, node: i }))
                    return a
                })(e, 0),
                n
            )
    ...
    return (function (n) {
        ...
        function p(e, n, r, i) {
                    ...
                    : (function () {
                          ...
                          if (_.keywords) {
                              for (n = 0, _.lexemesRe.lastIndex = 0, t = _.lexemesRe.exec(k), r = ""; t; ) {
                                  ...
                                  var a = null
                                  ;(e = l(_, t))
                                      ? (w.addText(r), (r = ""), (T += e[1]), (a = e[0]), w.addKeyword(t[0], a))
                                      : (r += t[0]),
            ...
            function b(n, t) {
                ...
                if ("begin" == f.type && "end" == t.type && f.index == t.index && "" === i) {
                    if (((k += s.slice(t.index, t.index + 1)), !o))
                        throw (((a = Error("0 width match regex")).languageName = e), (a.badRule = f.rule), a)
                    return 1
                }
                if (((f = t), "begin" === t.type))
                    return (function (e) {
                        ...
                        return t.__onBegin && (t.__onBegin(e) || {}).ignoreMatch
                            ...
                            : (t &&
                                  t.endSameAsBegin &&
                                  (t.endRe = RegExp(n.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"), "m")),
                              t.skip
                                  ? (k += n)
                                  : (t.excludeBegin && (k += n), c(), t.returnBegin || t.excludeBegin || (k = n)),
                              h(t),
                ...
                if ("end" === t.type) {
                    var l = (function (e) {
                        ...
                        if (r) {
                            ...
                            return (
                                r.starts && (r.endSameAsBegin && (r.starts.endRe = r.endRe), h(r.starts)),
            ...
            try {
                for (
                    ...
                    A++, B ? (B = !1) : ((_.matcher.lastIndex = L), _.matcher.considerAll()), (y = _.matcher.exec(s));
                ...
                return (
                    ...
                    w.finalize(),
                    (x = w.toHTML()),
                    { relevance: T, value: x, language: e, illegal: !1, emitter: w, top: _ }
                )
            } catch (n) {
        ...
        function v(e) {
            ...
            h(o) ||
                ...
                (r = o ? f(o, s, !0) : m(s)),
                (t = y(n)).length &&
                    (((a = document.createElement("div")).innerHTML = r.value), (r.value = O(t, y(a), s))),
                (r.value = b(r.value)),
        ...
        Object.assign(n, {
            ...
            registerLanguage: function (e, t) {
                ...
                try {
                    ...
                    if ((console.error("Language definition for '{}' could not be registered.".replace("{}", e)), !o))
                        throw n
                    console.error(n), (r = E)
                }
                r.name || (r.name = e),
            ...
            return {
                ...
                contains: a.concat([
                    ...
                    },
                    {
                        ...
                        illegal: /[:="\[\]]/,
                        contains: [
                            { beginKeywords: "extends", endsWithParent: !0, illegal: /[:="\[\]]/, contains: [t] },
                            t,
                        ],
                    },
                ...
                contains: [
                    ...
                    { className: "section", begin: /\[+/, end: /\]+/ },
                    {
                        ...
                        starts: {
                            ...
                            contains: [
                                a,
                                { begin: /\[/, end: /\]/, contains: [a, i, s, t, n, "self"], relevance: 0 },
                                i,
                                s,
                                t,
                                n,
                ...
                t = {
                    ...
                    variants: [
                        ...
                        { begin: /\B\?(\\\d{1,3}|\\x[A-Fa-f0-9]{1,2}|\\u[A-Fa-f0-9]{4}|\\?\S)\b/ },
                        {
                            ...
                            contains: [
                                { begin: /<<[-~]?'?/ },
                                { begin: /\w+/, endSameAsBegin: !0, contains: [e.BACKSLASH_ESCAPE, c] },
                            ],
                        },
                    ],
                },
...
hljs.registerLanguage(
    ...
    (function () {
        ...
        return function (e) {
            ...
            return (
                (i.contains = [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, o, c, E, s, e.REGEXP_MODE]),
                {
                    name: "TypeScript",
                    aliases: ["ts"],
                    keywords: n,
    ...
    (function () {
        ...
        return function (e) {
            var n = { begin: /<[A-Za-z0-9\\._:-]+/, end: /\/[A-Za-z0-9\\._:-]+>|\/>/ },
                ...
                i = { className: "subst", begin: "\\$\\{", end: "\\}", keywords: s, contains: [] },
                t = {
                    begin: "html`",
                    end: "",
                    starts: { end: "`", returnEnd: !1, contains: [e.BACKSLASH_ESCAPE, i], subLanguage: "xml" },
